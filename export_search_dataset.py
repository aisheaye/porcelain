...
def main():
    ...
    for row in rows:
        item = {
            ...
            "preferred_image_url": row["cloud_image_url"] or row["image_url"],
            "local_image_path": row["local_image_path"],
            "local_image_dir": row["local_image_dir"],
            "cloud_image_url": row["cloud_image_url"],
            "cloud_image_dir": row["cloud_image_dir"],
            "cloud_storage_key": row["cloud_storage_key"],
